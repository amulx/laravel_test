 ...
 */
class Kuaidi extends BaseResponse implements InterfaceResponse
{
    private $_APPKEY = 'c684ab43a28bc3caea53570666ce9762'; 
     ...
     * @var string
     */
    protected $method = 'kuaidi';
    /**
     * 您获得的快递网接口查询KEY。
     * @param string $key
     */
    public function KuaidiAPi($key){
        $this->_APPKEY = 'c684ab43a28bc3caea53570666ce9762';
    }
    ...
    {
        // return $this->query('70828177341144', 'huitongkuaidi');
        return [
            'status' => true,
            'code'   => '200',
            'data'   => $this->query($params['nu'], $params['com'])
        ];
    }
}